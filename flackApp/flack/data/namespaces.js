...
let slack = new Namespace(3, 'Slack', 'https://upload.wikimedia.org/wikipedia/commons/7/76/Slack_Icon.png', '/slack');
let linuxNs = new Namespace(2, 'Linux', 'https://upload.wikimedia.org/wikipedia/commons/a/af/Tux.png', '/linux');

namespaces.push(wikiNs, mozNs, linuxNs, slack);
...
slack.addRoom(new Room(0, 'Dev', 'Linux'));
slack.addRoom(new Room(1, 'Red Hat', 'Linux'));
slack.addRoom(new Room(2, 'MacOs', 'Linux'));
slack.addRoom(new Room(3, 'Kernal Development', 'Linux'));
